...
import type { ArtistResponse, AlbumResponse } from '../api/client'
...
export default function ManagementPage() {
  ...
  const stats = [
    ...
    { label: 'Active Nodes', value: '42.8k', change: 'Peak', icon: '📈' },
    { label: 'Server Health', value: 'Uptime', change: '99.9%', icon: '⊟' },
  ]
